...
# Configure page
st.set_page_config(
    page_title="Dataset Information - RMNIHR Virology Dept.",
...
st.write("Representative processed training snapshots from the RMNIHR Virology Dept. database:")
...
st.write("Comparative analysis of the evaluated models for RMNIHR Virology Dept.:")
