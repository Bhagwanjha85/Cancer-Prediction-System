...
st.markdown(
    ...
    <div style="text-align: center; padding: 20px 0px 40px 0px;">
        <h1 style="font-size: 3rem; margin-bottom: 10px; background: linear-gradient(135deg, #FF006E 0%, #3A86FF 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
...
with col1:
    st.markdown(
        ...
        <div class="glass-card">
            <h3 style="color: #FF006E; margin-top:0;">Oral Cancer Screening</h3>
...
with col2:
    st.markdown(
        """
        <div class="glass-card">
            <h3 style="color: #3A86FF; margin-top:0;">Skin Cancer Screening</h3>
            <p style="color: #E2E8F0; font-size: 0.95rem;">
...
with w_col1:
    st.markdown(
        """
        <div style="background: rgba(30, 41, 59, 0.3); padding: 20px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.05); text-align: center; min-height: 220px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#FF006E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-bottom:15px;"><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3z"/><circle cx="12" cy="13" r="3"/></svg>
...
with w_col2:
    st.markdown(
        """
        <div style="background: rgba(30, 41, 59, 0.3); padding: 20px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.05); text-align: center; min-height: 220px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#3A86FF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-bottom:15px;"><rect width="16" height="16" x="4" y="4" rx="2"/><rect width="6" height="6" x="9" y="9" rx="1"/><path d="M9 1v3"/><path d="M15 1v3"/><path d="M9 20v3"/><path d="M15 20v3"/><path d="M20 9h3"/><path d="M20 15h3"/><path d="M1 9h3"/><path d="M1 15h3"/></svg>
...
with w_col4:
    st.markdown(
        """
        <div style="background: rgba(30, 41, 59, 0.3); padding: 20px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.05); text-align: center; min-height: 220px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#F59E0B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-bottom:15px;"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
...
st.markdown(
    ...
    <div class="medical-disclaimer-banner">
        <h5 style="color: #EF4444; margin: 0 0 5px 0; font-weight: bold; font-family: 'Outfit';">CRITICAL CLINICAL DISCLAIMER</h5>
